...
# ⚠ Bien pointer tetepartete_itip/prepare/tetepartete_itip.PARQUET (l'export de
# la table compte) — le flux voisin tetepartete_re/prepare/tetepartete_re.PARQUET
# est un autre flux (colonnes différentes).
CPT_PARQUET_PATH = "/mnt/lake/compteclient/data/compteclient/tetepartete_itip/prepare/tetepartete_itip.PARQUET"
